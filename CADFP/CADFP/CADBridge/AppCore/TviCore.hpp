...
#include "TvGsView.h"
#include "../CADBaseViewController.h"
...
public:
    ...
    void attach(CADBaseViewController* controller) { m_pParentController = controller; }
    ...
    //需求添加
    //获取layer层
    OdTvLayersIteratorPtr getLayers();
    //获取UInt32颜色
    ...
    ////更改背景
    void changeBackground(int blackOrWhite);
...
private:
    ...
    // render controller
    CADBaseViewController* m_pParentController;
    // file extension
